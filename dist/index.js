...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Model$HomeRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Model$AboutRoute,
				_evancz$url_parser$UrlParser$s('about')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Model$PortfolioRoute,
					_evancz$url_parser$UrlParser$s('portfolio')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Model$ContactRoute,
...
var _user$project$Routing$parseLocation = function (location) {
	...
	if (_p0.ctor === 'Just') {
		...
		return _user$project$Model$NotFoundRoute;
	}
};
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Styles$MenuLink,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Color$text(
								A3(_elm_lang$core$Color$rgb, 129, 162, 178)),
							_1: {
								ctor: '::',
...
var _user$project$View_AboutPage$constant = function (_p0) {
	return A3(
		_mdgriffith$style_elements$Element$el,
		_user$project$Styles$Constant,
		{ctor: '[]'},
		_mdgriffith$style_elements$Element$text(_p0));
};
var _user$project$View_AboutPage$aboutItem = function (bullet) {
	return function (_p1) {
		return A3(
			...
			A2(
				...
				A3(
					...
					_user$project$Styles$AboutBullet,
					{
						...
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$paddingRight(12),
							_1: {ctor: '[]'}
						}
					},
					_mdgriffith$style_elements$Element$text(bullet)),
				_p1));
	};
};
...
var _user$project$View_ContactPage$contactPage = A3(
	...
	},
	{
		...
		_0: A2(
			...
			'mailto:alexander.bronca@gmail.com',
			A3(
				_mdgriffith$style_elements$Element$el,
				_user$project$Styles$MenuLink,
				{ctor: '[]'},
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_mdgriffith$style_elements$Element$link,
					'https://www.linkedin.com/in/albronca',
					A3(
						_mdgriffith$style_elements$Element$el,
						_user$project$Styles$MenuLink,
						{ctor: '[]'},
		...
		_1: {
			...
			_0: A2(
				...
				A3(
					...
					_user$project$Styles$MenuLink,
					{ctor: '[]'},
					_mdgriffith$style_elements$Element$text('portfolio'))),
			_1: {
				ctor: '::',
				_0: A2(
					_mdgriffith$style_elements$Element$link,
...
var _user$project$View$currentPage = function (model) {
	...
	switch (_p0.ctor) {
		...
		case 'ContactRoute':
			return _user$project$View$withBackButton(_user$project$View_ContactPage$contactPage);
		default:
			return _mdgriffith$style_elements$Element$empty;
	}
};
var _user$project$View$header = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$Styles$Header,
	{
		ctor: '::',
	...
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _mdgriffith$style_elements$Element$text('alexander bronca'),
			_1: {ctor: '[]'}
		}
	});
